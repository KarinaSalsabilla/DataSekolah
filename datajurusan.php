...
<head>
  ...
  <title>DataSekolah | Data jurusan</title>
  ...
  <style>
    ...
    /* Hapus table-responsive class dari HTML dan ganti dengan CSS ini */

    /* Base Table Styles - tetap sama */
    /* .table {
      border-radius: 15px;
      overflow: hidden;
      background: white;
...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
      ...
      <div class="app-content">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
              ...
              <div class="card mb-4 slide-in">
                ...
                <div class="card-body p-0">
                  <div class="table-responsive">
                    <!-- Tabel Data Jurusan -->
                  <table id="dataTablejurusan" class="table table-striped">
                    <thead>
                      <tr>
                        <th>No</th>
                        <th>Nama Jurusan</th>
                          ...
                          <?php if ($role == 'admin'): ?>
                            <td>
                              ...
                              <button
                                ...
                                data-kode-jurusan="<?= $x['kode_jurusan']; ?>"
                                data-nama="<?= $x['nama_jurusan']; ?>">
                                Edit
            ...
            <?php if ($role == 'admin'): ?>
              <!-- SEMUA MODAL DIPINDAH KE LUAR STRUKTUR CARD -->
                  ...
                  <div class="modal-content">
                    <form action="editjurusan.php" method="POST">
                      <div class="modal-header">
                        <h5 class="modal-title  bi bi-pencil-square " id="exampleModalLabel"> Edit Data Jurusan</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                      </div>

                      <div class="modal-body">
                        <div class="mb-3">
                          <label for="modal-nama" class="form-label">Nama Jurusan</label>
                      ...
                      <div class="modal-footer">
                        ...
                        <button type="submit" name="edit_jurusan" class="btn btn-primary">Update Data</button>
                      </div>
                    </form>
                  </div>
                </div>
                  ...
                  <div class="modal-content">
                    <div class="modal-header bg-danger text-white">
                      <h5 class="modal-title" id="confirmDeleteModalLabel">
                        <i class="bi bi-exclamation-triangle-fill"></i> Konfirmasi Hapus Data Jurusan
                      </h5>
                    ...
                    <div class="modal-body">
                      ...
                      <!-- Form View-Only untuk Preview Data -->
                      <div class="card">
                        <div class="card-header ">
              ...
              <div class="modal fade" id="modalTambahSiswa" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="modalTambahSiswaLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-md">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title bi bi-plus-circle-fill " id="modalTambahSiswaLabel"> Tambah Data Jurusan</h5>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                      <?php include 'formJurusan.php'; ?>
                    </div>
                  </div>
                </div>
              </div>
  ...
  <script>
    ...
    $(document).on('click', '.btn-edit', function() {
      var kode = $(this).data('kode-jurusan');
      var nama = $(this).data('nama');

      $('#modal-kode-jurusan').val(kode);
      $('#modal-nama').val(nama);
    });
    ...
    //   var kodeJurusan = button.data('kode-jurusan');
    //   var confirmButton = $(this).find('#confirmDeleteButton');
    //   confirmButton.attr('href', 'hapusjurusan.php?kode_jurusan=' + kodeJurusan);
    // });
  </script>
...
<script>
  // JavaScript untuk Modal Hapus dengan Form View-Only
  $('#confirmDeleteModal').on('show.bs.modal', function(event) {
    var button = $(event.relatedTarget);
    var kodeJurusan = button.data('kode-jurusan');
    var namaJurusan = button.data('nama');

    var modal = $(this);
    modal.find('#delete-nama').val(namaJurusan);
    modal.find('#confirmDeleteButton').attr('href', 'hapusjurusan.php?kode_jurusan=' + kodeJurusan);
  });
</script>
