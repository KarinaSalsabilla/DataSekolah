...
<aside class="app-sidebar bg-primary-subtle" data-bs-theme="dark">
  ...
  <img
    src="images/SMK-N-6-Surakarta.png"
    alt="Logo"
    class="brand-image opacity-80 shadow"
    style="opacity: 1; width: 60px; height: 60px; object-fit: cover;">
  <span class="brand-text fw-light">DataSekolah</span>
</a>
    <!--end::Brand Link-->
  </div>
  <!--end::Sidebar Brand-->
      ...
      <ul
        ...
        <li class="nav-item">
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
              <a href="datagama.php" class="nav-link">
                <i class="nav-icon bi bi-circle"></i>
                <p>Agama</p>
              </a>
            </li>
